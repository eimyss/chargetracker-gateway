...
public class ProjectControllerTest {
  ...
  public void getAccountList() throws Exception {
    ...
    mockMvc.perform(get("/projects/get/all").header(AUTHORIZATION_HEADER, String.format("%s %s", BEARER_TOKEN_TYPE, token)).with(authentication((Authentication) mockPrincipal)))
