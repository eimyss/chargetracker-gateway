...
public class TransactionClientTest {
  ...
  @Test
  public void testGetAllTranscations() {
    ResponseEntity<List> response = transactionsClient.getAllTransactions();
  ...
  public void testGetTransactionById() {
    ResponseEntity response = transactionsClient.getTransaction(1);
    assertNotNull(response);
    assertNotNull(response.getBody());
    assertNotEquals(response.getBody(), "");
    logger.info(response.toString());
